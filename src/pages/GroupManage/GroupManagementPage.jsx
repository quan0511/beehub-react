    ...
    return (
        <Container fluid>
            <Row className="group-manage-page position-relative ps-4 mx-auto text-center "style={{marginBottom: "100px"}}>
                ...
                <h3>Settings</h3>
                    <hr/>
                    <button className="nav-link text-start text-black fs-5 active" id="v-tabs-notification-tab" data-bs-toggle="tab" data-bs-target="#v-tabs-notification" type="button" role="tab" aria-controls="v-tabs-notification" aria-selected="true">Notifications</button>
                    <button className="nav-link text-start text-black fs-5" id="v-tabs-general-tab" data-bs-toggle="tab" data-bs-target="#v-tabs-general" type="button" role="tab" aria-controls="v-tabs-general" aria-selected="false">General Setting</button>
                ...
                <Col xl={8} lg={8} md={8} sm={12} className="tab-content " >
                    <div className="tab-pane fade show active text-start px-2 " id="v-tabs-notification" role="tabpanel" aria-labelledby="v-tabs-notification" tabIndex="0">
                        <SessionLeftGroup requirements={group.requirements} handleButton={handleButton}/>
                    </div>
                    <div className="tab-pane fade text-start px-2 " id="v-tabs-general" role="tabpanel" aria-labelledby="v-tabs-general" tabIndex="0">
